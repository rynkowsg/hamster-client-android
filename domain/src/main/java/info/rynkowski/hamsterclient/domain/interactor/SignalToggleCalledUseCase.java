...
public class SignalToggleCalledUseCase extends UseCaseArgumentless<Void> {

  private HamsterRepository hamsterRepository;

  @Inject public SignalToggleCalledUseCase(@Named("remote") HamsterRepository hamsterRepository,
